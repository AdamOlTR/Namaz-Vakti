...
python3 /home/oberadencamii/Namaz-Vakti/Namaz-Vakti/Main.py &
PYTHON_PID=$!
...
/usr/bin/chromium-browser --noerrdialogs --disable-infobars --kiosk --no-sandbox --ignore-certificate-errors --disable-web-security --user-data-dir=/home/oberadencamii/chrome_data /home/oberadencamii/Namaz-Vakti/Namaz-Vakti/namaz_times.html &

# Hide the mouse cursor after 0.1 seconds of inactivity
if ! command -v unclutter &> /dev/null
then
    echo "unclutter not found. Installing unclutter..."
    sudo apt-get update
