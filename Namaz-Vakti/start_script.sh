...
# Check if unclutter is installed, if not install it
...
/usr/bin/chromium-browser --noerrdialogs --disable-infobars --kiosk --no-sandbox --ignore-certificate-errors --disable-web-security --user-data-dir=/home/tugay/chrome_data 
