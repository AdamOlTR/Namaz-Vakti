...
try:
    ...
    def update_namaz_times():
        ...
        if df is not None:
            ...
            if not todays_times.empty:
                ...
                html_file_path = os.path.join(os.path.expanduser("~"), "Namaz-Vakti", "namaz_times.html")
    ...
    def open_chrome():
        file_path = os.path.abspath(os.path.join(os.path.expanduser("~"), "Namaz-Vakti", "namaz_times.html"))
