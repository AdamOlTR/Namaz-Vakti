...
try:
    ...
    def update_namaz_times():
        ...
        if df is not None:
            ...
            if not todays_times.empty:
                ...
                with open("/home/tugay/Namaz-Vakti/Namaz-Vakti/namaz_times.html", "r+", encoding="utf-8") as file:
    ...
    def open_chrome():
        file_path = os.path.abspath("/home/tugay/Namaz-Vakti/Namaz-Vakti/namaz_times.html")
